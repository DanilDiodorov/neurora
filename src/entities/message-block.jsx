    ...
    useEffect(() => {
        ...
        if (textRef.current.querySelector('pre') !== null) {
            textRef.current.querySelectorAll('pre').forEach((el) => {
                ...
                div.innerHTML = `<div class="copy-button" onclick="{ function copyText() {
                    var textToCopy = document.getElementById('${el.id}')
                    var currentRange
                ...
                }copyText()}"><img src="https://previews.123rf.com/images/martialred/martialred1507/martialred150700816/42614825-copy-document-file-line-art-icon-for-apps-and-websites.jpg" /></div>`
                el.prepend(div)
            })
        }
    }, [text, loading])
